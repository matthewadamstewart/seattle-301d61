...
function displayPics(){
  ...
  // The reason is because let is specifically scoped to the code block it is in,
  // and the console.log(rando) was outside the curly braces which define the code block, so i moved it to within the code block.
  // It also would have worked if within the second while loop because that is also inside the same code block.
  // Just reread the direction and deleting the console console.log(rando) completely
